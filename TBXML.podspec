#
#  Be sure to run `pod spec lint TBXML.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://www.71squared.com"
  ...
  # s.author    = "Mykola Stukalo"
  s.authors            = { "Tom Bradley" => "tom@tbxml.co.uk" }
  # s.social_media_url   = "http://twitter.com/Mykola Stukalo"
